...
export class Book extends Component {
  ...
  updatePageloadData = () => {
    console.log("loadthis.state.timeOnTaskUuid",this.state.timeOnTaskUuid)
    
  }

  updatePageUnLoadData = () => {
     console.log("this.state.timeOnTaskUuid",this.state.timeOnTaskUuid)
