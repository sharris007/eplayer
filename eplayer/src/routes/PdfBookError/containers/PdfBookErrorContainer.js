...
import PdfBookErrorPage from '../components/PdfBookErrorPage';/* Importing LoginPage component for connecting purpose. */
...
export default connect(mapStateToProps, mapDispatchToProps)(PdfBookErrorPage);
