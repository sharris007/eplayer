        ...
        <AppBar
          ...
          iconElementRight={
            ...
            {this.props.isET1 === 'Y' && !this.props.bookData.bookFeatures.haszoominbutton && !this.props.bookData.bookFeatures.haszoomoutbutton ?
              ...
              {this.props.isET1 ? <div className="preferences-container-eT1">{this.state.prefOpen ? <div className="content"><PreferencesComponent isET1={this.props.isET1} fetch={this.props.getPreference} setCurrentZoomLevel={this.props.setCurrentZoomLevel} disableBackgroundColor={this.props.disableBackgroundColor} preferenceUpdate={this.props.preferenceUpdate} /></div> : <div className="empty" />} </div>
