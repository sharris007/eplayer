...
const moreMenuActions = {
  ...
  logoutUserSession(userid, sessionKey, scenario, serverDetails) {
    const serviceurl = `${serverDetails}/ebook/pdfplayer/logout?values=userid::${userid}::sessionid::${sessionKey}::scenario::${scenario}::authservice::sso::authkey::${sessionKey}&authkey=${sessionKey}`;
