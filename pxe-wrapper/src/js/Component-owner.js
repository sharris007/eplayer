...
class ComponentOwner extends React.Component {
  ...
  render() {    
    return (
        ...
        <div>     
          <div>{(this.state.popUpCollection.length > 0) ? <PopUpInfo popUpCollection = {this.state.popUpCollection} bookId = "bookDiv" node={document.getElementById(this.props.node)}/> : ''}</div>
